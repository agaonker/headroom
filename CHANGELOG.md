...
## [0.27.0](https://github.com/agaonker/headroom/compare/v0.26.0...v0.27.0) (2026-06-18)
...
* add lean-ctx context tool support ([4b06179](https://github.com/agaonker/headroom/commit/4b061792b29f776f36831530ba6fdbfd6d71ad0b))
...
* **ci:** X2 — PR-time release dry-run via path-filtered pull_request trigger ([7a06355](https://github.com/agaonker/headroom/commit/7a063554ce03c04cbacd45d548f513f99dcde95a))
* **ci:** X2 — PR-time release dry-run via path-filtered pull_request trigger ([b9f84fa](https://github.com/agaonker/headroom/commit/b9f84fa815a2696a85ed3f430d52b6ccaf36ac82))
...
* **proxy:** add --exclude-tools flag + HEADROOM_EXCLUDE_TOOLS env var ([1058043](https://github.com/agaonker/headroom/commit/10580439bb4227a3f6f375439b0baae60db2f288))
* **proxy:** add --exclude-tools flag + HEADROOM_EXCLUDE_TOOLS env var ([93cf8af](https://github.com/agaonker/headroom/commit/93cf8af0e0c6b6b7fee0bcfe5b57a514c294a898))
...
* **proxy:** add client (harness) identification — per-harness analytics across every handler ([96a674f](https://github.com/agaonker/headroom/commit/96a674f1b9c7d0b251478bb53541f8fbd6859e1f))
...
* add Codex wire debug and WS usage metrics ([7c94e72](https://github.com/agaonker/headroom/commit/7c94e728410d8784ecdcddb3d7c9bd6dc079e376))
* add Codex wire debug and WS usage metrics ([2b331e2](https://github.com/agaonker/headroom/commit/2b331e297a02b0a685b9f3fdf2432eefc3cdcccd))
* add Kompress backend and thread controls ([a2ea964](https://github.com/agaonker/headroom/commit/a2ea9648a4380fee97a4ad2b98ed0197d8ea03f0))
* align docs and prune dead compatibility surfaces ([359e8c9](https://github.com/agaonker/headroom/commit/359e8c9a5b6f4dfc0c4126affd3308893da4c421))
...
* batch and guard Kompress inference ([b946a44](https://github.com/agaonker/headroom/commit/b946a44c44a74ec601fd9fb4b97a4199b6c9b792))
* **bedrock:** apply rustfmt to header_value_preview tests ([42ff8af](https://github.com/agaonker/headroom/commit/42ff8afa90c29a11079256bbe2d4a96878d708c6))
* **bedrock:** use floor_char_boundary to avoid UTF-8 slice panic in header preview ([399cb32](https://github.com/agaonker/headroom/commit/399cb32fa475ebbc0e6790024f77675d6b72f4fd))
* **bedrock:** use floor_char_boundary to avoid UTF-8 slice panic in header preview ([82468e4](https://github.com/agaonker/headroom/commit/82468e4e99e6013ab9a44df2e2f12c9352bbc18f)), closes [#415](https://github.com/agaonker/headroom/issues/415)
* **bedrock:** use is_char_boundary loop instead of floor_char_boundary (MSRV 1.80) ([b784f40](https://github.com/agaonker/headroom/commit/b784f400c109b51352825d68341a2801a29123d6))
* **build:** shrink Rust extension wheels — strip + thin-LTO + single codegen unit ([d73cbd6](https://github.com/agaonker/headroom/commit/d73cbd6b0aea20a0e99d29e6c775f26d27f59eb5))
* **build:** shrink Rust extension wheels (strip + thin-LTO + single codegen unit) ([ec8e208](https://github.com/agaonker/headroom/commit/ec8e2080f3231353f11589016a191dd02e100b98))
...
* **ci:** docker per-arch bake needs explicit image name in output ([c81755c](https://github.com/agaonker/headroom/commit/c81755c965bd5d57533d75939e1017ad0ff60435))
* **ci:** docker per-arch bake needs explicit image name in output ([8f6bc58](https://github.com/agaonker/headroom/commit/8f6bc5865c33e5bf7e9b5f59986f24d7d98096df))
* **ci:** force-link glibc shim with -Wl,-u for aarch64 ([39cb7c4](https://github.com/agaonker/headroom/commit/39cb7c4dc4102a9e14ecaf9c35deb6bd3186830b))
* **ci:** force-link glibc shim with -Wl,-u so aarch64 wheel includes it ([820e66c](https://github.com/agaonker/headroom/commit/820e66cae65723a7691f7b79707a6f077ac266f0))
* **ci:** glibc shim — drop alias attribute, forward-declare strtol ([af0a960](https://github.com/agaonker/headroom/commit/af0a9604ee5503d1e7b89e8cf41224a306568fce))
* **ci:** glibc shim — drop alias attribute, forward-declare strtol ([6b15acc](https://github.com/agaonker/headroom/commit/6b15acc3b572381260e9c3f068bc5c43bb9eda18))
* **ci:** include NOTICE in sdist + assert License-File metadata matches tarball ([fc6b0a0](https://github.com/agaonker/headroom/commit/fc6b0a0917063df89058d4d01292f43667656c8f))
* **ci:** include NOTICE in sdist + assert License-File metadata matches tarball ([183d51c](https://github.com/agaonker/headroom/commit/183d51c8a860a5ca8d00c091df89c398ffb0425e))
...
* **ci:** pypi publish skip-existing to unblock idempotent re-runs ([f94a9d2](https://github.com/agaonker/headroom/commit/f94a9d22bace56af115bb48c38f4539a9bb4a5f4))
* **ci:** pypi publish skip-existing to unblock idempotent re-runs ([6a191b4](https://github.com/agaonker/headroom/commit/6a191b405b5c9bdbcdab4eb1250bea9fa295f18f))
* **ci:** rebuild sdist on the renamed wheel-matrix host ([31bd9f7](https://github.com/agaonker/headroom/commit/31bd9f78e23a6de20cdc318dc26cd774a62d073b))
* **ci:** rebuild sdist on the renamed wheel-matrix host ([75576da](https://github.com/agaonker/headroom/commit/75576dae2bca18610b870b2706c6b54e007dda13))
* **ci:** replace ls with find in smoke-import wheel discovery ([3e78421](https://github.com/agaonker/headroom/commit/3e784212673a6ffc1b82bcb3f478998c6ff8433b))
...
* **ci:** skip smoke OpenAI eval cleanly when OPENAI_API_KEY secret unset ([a281de6](https://github.com/agaonker/headroom/commit/a281de6bb0279c05a2b44cc868bde9a0428ba82f))
* **ci:** smoke-import wheels on customer-representative envs before publish (X1) ([596212b](https://github.com/agaonker/headroom/commit/596212b428ba2019885b49381ffdf9cb309ec8e3))
* **ci:** stage smoke-import script as host file (broke main post-[#387](https://github.com/agaonker/headroom/issues/387)) ([7fe2d1e](https://github.com/agaonker/headroom/commit/7fe2d1e5b632c3e5424f5364baef0ef8af6510a4))
* **ci:** stage smoke-import script as host file (broke main) ([e536d9b](https://github.com/agaonker/headroom/commit/e536d9b1801652ff6d4b9bce9683f155029b23c7))
* **ci:** update sdist license-packaging invariant test to match new shape ([cd89a82](https://github.com/agaonker/headroom/commit/cd89a8297ae55fe26343fc101b695953f07969de))
* **ci:** update sdist license-packaging invariant test to match new shape ([37c0df2](https://github.com/agaonker/headroom/commit/37c0df23b6cc7bf3e1fbc4f7ad67499a61eb539e))
* **ci:** update tests to assert absence of requires_openai_auth (bug 3, [#406](https://github.com/agaonker/headroom/issues/406)) ([4071d57](https://github.com/agaonker/headroom/commit/4071d571345c5a88df56eac5ad975200831e9b7d))
* **ci:** X1 — smoke-import wheels on customer-representative envs before publish ([4745219](https://github.com/agaonker/headroom/commit/4745219901003be6607df2219e4ce672187b8f27))
* clear CI mypy + rust test failures introduced in eaf5980 ([17ffae0](https://github.com/agaonker/headroom/commit/17ffae0cd8e4498bf60f4fa5a36521905f9fb151))
* **cli:** G1 remediation — non-string clobber, per-model systemMessage, openhands gate ([ea1976e](https://github.com/agaonker/headroom/commit/ea1976e37a5147ecf37dbf5ffe4af5c2f2d1be6a))
* **cli:** proxy/perf/wrap UX cleanup + perf --hours correctness ([9ff28e9](https://github.com/agaonker/headroom/commit/9ff28e9803eaba3c1be9c20924d7b34d98f507b0))
* **cli:** proxy/perf/wrap UX cleanup + perf --hours correctness ([265554d](https://github.com/agaonker/headroom/commit/265554d4adee7fbf03234a6de832293dec95f811))
* **cli:** resolve duplicate --code-aware flag breaking proxy import ([5dd2ac5](https://github.com/agaonker/headroom/commit/5dd2ac5e516b9f429648ca5a48be9bb1a6bacb0b))
* **cli:** wrap CLI breadth — cline, continue, goose, openhands ([8625f80](https://github.com/agaonker/headroom/commit/8625f8075ed75d2a002f6ba357697de0fa1ec434))
* **cli:** wrap subcommands for cline, continue, goose, openhands ([c375fa1](https://github.com/agaonker/headroom/commit/c375fa156dd0434256805f274c07be4f45db9814))
* Codex ws cancel logging ([73b0e56](https://github.com/agaonker/headroom/commit/73b0e56e970c6f805a1d174f50b886000372cdb2))
...
* **codex:** bug 3 — strip requires_openai_auth, restore consistent openai_base_url injection ([6c4ddc8](https://github.com/agaonker/headroom/commit/6c4ddc824e074245ffd6ea8002a068cb108f27fb))
...
* **codex:** drop env_key from provider blocks to preserve subscription auth ([32f499c](https://github.com/agaonker/headroom/commit/32f499cbba4c370865105a55748a365294ec5815))
...
* **codex:** inject openai_base_url in init and persistent-install paths ([bf1e31b](https://github.com/agaonker/headroom/commit/bf1e31b27c64ad9400d2997ce1f70692ebb408d0))
...
* **codex:** restore openai_base_url top-level injection for subscription routing ([d54c5b6](https://github.com/agaonker/headroom/commit/d54c5b6a5840fabf0d28079fe67fb0347f016fbb))
...
* **codex:** strip requires_openai_auth and openai_base_url injection (bug 3, [#406](https://github.com/agaonker/headroom/issues/406)) ([09b8510](https://github.com/agaonker/headroom/commit/09b851001bf6a2e6ccc34478e42f54c87ddaf5d3))
...
* complete /v1/responses compression telemetry, multi-frame WS, frozen-count cap ([89f7b6c](https://github.com/agaonker/headroom/commit/89f7b6c2dd0f3503312490b2052f534e76c01ac3))
* Compress Codex Responses payloads ([d90d2ca](https://github.com/agaonker/headroom/commit/d90d2caed3b1c3199dd89714a7f0a330b23db59f))
...
* **content-router,proxy:** cache-safe text-block compression and online streaming usage ([ecb3e00](https://github.com/agaonker/headroom/commit/ecb3e00451f5fd62a2be9d924996c2f075a3de2d))
* **content-router,proxy:** cache-safe text-block compression and online streaming usage ([79baee0](https://github.com/agaonker/headroom/commit/79baee082f894cf0c467468eed1ae2fed04f37e6))
* **content-router,proxy:** compress text blocks + close DeepSeek metrics gaps ([d322e6d](https://github.com/agaonker/headroom/commit/d322e6df1fc0f949469242488c5c0080beb206a1))
* **content-router,proxy:** compress text blocks + close DeepSeek metrics gaps ([d955abb](https://github.com/agaonker/headroom/commit/d955abb1d65a14e07b5c6a915cafc12ddb12ace7))
...
* **core:** expose compress_openai_responses_live_zone via PyO3 (hot-fix c1/2) ([c48735d](https://github.com/agaonker/headroom/commit/c48735d0298b94d25d40397ea64a2d66d1e557d0))
* **core:** F2.2 c1/3 — extend CompressionPolicy with three per-mode tuning fields ([797dc63](https://github.com/agaonker/headroom/commit/797dc63da747dd8594958709271abd658de4a5c0))
* **core:** introduce CompressionPolicy struct + auth_mode mapping (F2.1 c1/6) ([8376630](https://github.com/agaonker/headroom/commit/837663006254cde327e9c7f71b2ea5682f9b902e))
...
* **crusher:** bridge SmartCrusher row-drop hash to Python compression_store ([#389](https://github.com/agaonker/headroom/issues/389)) ([e664f11](https://github.com/agaonker/headroom/commit/e664f11260e997c9e643feec8b2cff27f127660f))
* **crusher:** bridge SmartCrusher row-drop hash to Python compression_store ([#389](https://github.com/agaonker/headroom/issues/389)) ([a40d4a5](https://github.com/agaonker/headroom/commit/a40d4a5f6d3183c94941a7ffe8c28bcb5d769792))
* **crusher:** shim __libc_single_threaded for glibc &lt; 2.32 + extend audit ([19a43f0](https://github.com/agaonker/headroom/commit/19a43f0d52a0b406b1e0cae2804fe0e204b4dcba))
* **crusher:** shim __libc_single_threaded for glibc &lt; 2.32 + extend audit ([17d6207](https://github.com/agaonker/headroom/commit/17d6207bf544ddb670236be67d4530c8913e735f))
* **crusher:** switch compression_store cache key from MD5 to SHA-256 (CodeQL [#395](https://github.com/agaonker/headroom/issues/395)) ([af9e628](https://github.com/agaonker/headroom/commit/af9e6282f89ff4fb2e0052fd58314d407997b7e6))
...
* expose code-aware flag ([7d99a71](https://github.com/agaonker/headroom/commit/7d99a71285b3b3ec5c475c0676aa1a4a0887fbe7))
* expose compression latency bottlenecks ([4e146b0](https://github.com/agaonker/headroom/commit/4e146b0b5a12d1040bb8dddd88b3445fc6b2af87))
* expose compression latency bottlenecks ([e9cae01](https://github.com/agaonker/headroom/commit/e9cae0131bfe0c3b6db9096b2c5604259bda673d))
* format Codex compression changes ([03d12fc](https://github.com/agaonker/headroom/commit/03d12fc14039d64fc6b53507a28308177661ab41))
* format Kompress tests for ruff ([fc0cba7](https://github.com/agaonker/headroom/commit/fc0cba7b48cf7cefbef1968f57527bdf5c2fe652))
...
* harden learn path handling across platforms ([9577ef8](https://github.com/agaonker/headroom/commit/9577ef811b3f078959fe821b39304977877f6f09))
* harden learn path handling across platforms ([5ceca13](https://github.com/agaonker/headroom/commit/5ceca13c656165209dacc35d1dc2cc0aebd1afe1))
* harden release gating and clarify pipx compatibility ([9492386](https://github.com/agaonker/headroom/commit/9492386398408ae6652aab58966fb16f4f26c2c8))
* harden release gating and clarify pipx Python compatibility ([a7e1f93](https://github.com/agaonker/headroom/commit/a7e1f931a5511294c1e3daa6992f72d195373677))
...
* inject openai_base_url so Codex subscription (ChatGPT plan) routes through proxy ([f0b40f1](https://github.com/agaonker/headroom/commit/f0b40f11d5dfdfa41debb069478f9ad283d753d6))
* inject openai_base_url so Codex subscription (ChatGPT plan) routes through proxy ([5c7a5b4](https://github.com/agaonker/headroom/commit/5c7a5b4857e4259ff16d272b1ba0308f3ac45282))
...
* log Codex ws cancellations safely ([62a1f23](https://github.com/agaonker/headroom/commit/62a1f23b8864f9b0a82dbab6225514f73b7ada9d))
...
* make proxy upgrades version-aware ([2732ae7](https://github.com/agaonker/headroom/commit/2732ae7d820451bafdefceb76513c4eba109b29b))
* make proxy upgrades version-aware ([ea1f608](https://github.com/agaonker/headroom/commit/ea1f608e79d8809ff4d7d2428972fdb633a01918))
* **mcp:** auto-register headroom MCP server in wrap claude/codex and init -g ([d9d8972](https://github.com/agaonker/headroom/commit/d9d8972ac4f51c0f018c470b8dba337cb959074d))
* **memory:** drop regex-based pref extraction; filter system-reminder noise (refs [#464](https://github.com/agaonker/headroom/issues/464)) ([1139b21](https://github.com/agaonker/headroom/commit/1139b21f2a9a39803bcc11b981c73890980508ee))
* **memory:** expose memory IDs in auto-tail + memory_list tool + ID-usage guidance ([f844f64](https://github.com/agaonker/headroom/commit/f844f64840491d9a838be4b00a4ca6d9ff97adba))
* **memory:** expose memory IDs in auto-tail + memory_list tool + ID-usage guidance ([c62d45e](https://github.com/agaonker/headroom/commit/c62d45eea826c661aa8ebf1f2c8aba8408ea6109))
* **memory:** per-project storage so projects can no longer bleed memories (refs [#462](https://github.com/agaonker/headroom/issues/462)) ([f8ffdbf](https://github.com/agaonker/headroom/commit/f8ffdbfe7369d49c23c67ca9a3c4668238aab508))
...
* **memory:** traffic_learner indexes system-reminder fragments as user preferences (refs [#464](https://github.com/agaonker/headroom/issues/464)) ([0be0eed](https://github.com/agaonker/headroom/commit/0be0eede9e09466e4ec0c0ee10b1d0aa317e0e73))
* narrow compressed type for mypy 1.14 in ContentRouter.compress ([05fe6c0](https://github.com/agaonker/headroom/commit/05fe6c010222921103651ebc3f9f4715a0418780))
* **observability:** G3 remediation — bound cardinality + wire dead metrics ([2a717a9](https://github.com/agaonker/headroom/commit/2a717a993ee99f9401f5cdf78a23dcecd7cb1a51))
* **observability:** RTK metrics + Rust observability (Phase H blocker) ([b36ad9f](https://github.com/agaonker/headroom/commit/b36ad9fe1c6a488eb9ffbf0e8b38d989278cf8ef))
* **observability:** wire Phase G PR-G3 RTK + proxy metrics (H-blocker) ([5f264a5](https://github.com/agaonker/headroom/commit/5f264a53292e292c9c56b837c2750d1a415b1ea9))
...
* per-project memory storage so projects can no longer bleed memories (GH [#462](https://github.com/agaonker/headroom/issues/462)) ([7694f05](https://github.com/agaonker/headroom/commit/7694f050fe3b4d80c82903f17f38a93b4b3d670e))
...
* populate Codex WS dashboard performance metrics ([4279a7f](https://github.com/agaonker/headroom/commit/4279a7f35349bde2b0361e9fe6e9f3a75adbf5de))
* PR [#281](https://github.com/agaonker/headroom/issues/281) — synthesize 5h subscription window after Anthropic reset (no extra polling) ([0b77955](https://github.com/agaonker/headroom/commit/0b77955ecb5b64ab4f8224f003dc532cf71d5909))
* PR [#372](https://github.com/agaonker/headroom/issues/372) — restore [image] extra on Python 3.13 via rapidocr 3.x adapter ([486372b](https://github.com/agaonker/headroom/commit/486372b6445bd217a6306159bb7210173d0578ec))
* PR-D3 Bedrock observability + auth-mode integration (Phase D close) ([0c46c7e](https://github.com/agaonker/headroom/commit/0c46c7e01070a3efa2fcfb420665fa0d420eeb58))
* PR-D4 native Vertex publisher path + ADC ([d3c70ac](https://github.com/agaonker/headroom/commit/d3c70acea5d2d893e6490b293a6b2f931a57a1d3))
* PR-E1 + PR-E2 tool array sort + schema-key sort (Phase E) ([c8e0b36](https://github.com/agaonker/headroom/commit/c8e0b367572d6c38dc4807955599e32b90248001))
* PR-E1 tool array deterministic sort (Phase E) ([4a3b76b](https://github.com/agaonker/headroom/commit/4a3b76bcc879b3ba4a6a29096b5b50cb87d34f40))
* PR-E2 recursive JSON Schema key sort (Phase E) ([9112fed](https://github.com/agaonker/headroom/commit/9112fed9379cfe43d31e935c9ac855116abd60f9))
* PR-E3 Anthropic cache_control auto-placement (Phase E) ([397c805](https://github.com/agaonker/headroom/commit/397c805698d01da20256d651a92a17429327cf6a))
* PR-E3 Anthropic cache_control auto-placement (Phase E) ([8672d5c](https://github.com/agaonker/headroom/commit/8672d5c32680c790bfb6c431c2d1a854fac6566b))
* PR-E4 OpenAI prompt_cache_key auto-injection (Phase E) ([2fc73d0](https://github.com/agaonker/headroom/commit/2fc73d0f73241a937304a8b8d4e11c550945e6df))
* PR-E4 OpenAI prompt_cache_key auto-injection (Phase E) ([573543f](https://github.com/agaonker/headroom/commit/573543fce7dcf461d8a65bbfde4a6f9a93cee351))
* PR-E5 volatile-content detector + customer warning (Phase E) ([d1b836d](https://github.com/agaonker/headroom/commit/d1b836d78c5b92ec12b565e58e47aaaa3e7bc209))
* PR-E5 volatile-content detector + customer warning (Phase E) ([d8aae38](https://github.com/agaonker/headroom/commit/d8aae382b00c0d340dd79ef89963126156f2f805))
* PR-E6 cache-bust drift detector telemetry (Phase E) ([41ca054](https://github.com/agaonker/headroom/commit/41ca0544c793731522a26a916bc351cc18a460bf))
* PR-E6 cache-bust drift detector telemetry (Phase E) ([ce37940](https://github.com/agaonker/headroom/commit/ce37940d17e149bf6961742472a61885de5f2e73))
...
* preserve Codex OAuth provider config ([7e29a60](https://github.com/agaonker/headroom/commit/7e29a60b6feca5848ce1a07119294d45a472c04e))
* preserve Codex OAuth proxy delivery ([06428d2](https://github.com/agaonker/headroom/commit/06428d20fd0514375024a6784b30b873a0f8d82d))
* **proxy,dashboard:** correct savings reporting ([71348f4](https://github.com/agaonker/headroom/commit/71348f407f5d3463165a44665bc48e40f7b29a69))
* **proxy,dashboard:** correct savings reporting for backend-routed traffic and drop broken Compression Quality widget ([6643266](https://github.com/agaonker/headroom/commit/6643266ec02abbdb54cd2910b3a23845c144805f))
* **proxy:** add auth_mode_policy_enforcement feature flag (F2.1 c3/6) ([027b203](https://github.com/agaonker/headroom/commit/027b203c2352693b53a54d9e7763cc61c19e2f20))
...
* **proxy:** bound Codex Responses compression work ([160989c](https://github.com/agaonker/headroom/commit/160989c43ecbe86d36c1c69681c578276c756285))
* **proxy:** F2.1 — per-auth-mode CompressionPolicy gates ([3b1ee2e](https://github.com/agaonker/headroom/commit/3b1ee2e4af9eba4318e748d65be88bb04daef81c))
* **proxy:** F2.2 — per-mode CompressionPolicy tuning fields ([294df2b](https://github.com/agaonker/headroom/commit/294df2b894a985c8501981de35865aa3245fbdc2))
...
* **proxy:** F4 — trust X-Forwarded-* only behind allow-listed gateway ([665c082](https://github.com/agaonker/headroom/commit/665c0823d96b461f6127debe2d19df4e91c7c918))
...
* **proxy:** hoist compression_policy outside is_token_mode branch (F2.1 c5 followup) ([708b87a](https://github.com/agaonker/headroom/commit/708b87a19fbe0c71ab5945ef8fda154f0abd2eef))
* **proxy:** hot-fix Codex /v1/responses compression via PyO3 inline call ([1a3098a](https://github.com/agaonker/headroom/commit/1a3098a48f8021e00c1fb118b1a5dab0b8add559))
* **proxy:** inline WebSocket /v1/responses compression via PyO3 ([1050e00](https://github.com/agaonker/headroom/commit/1050e00241960e475e63badd59c175abc5b3e7cf))
* **proxy:** inline WebSocket /v1/responses compression via PyO3 ([4a50313](https://github.com/agaonker/headroom/commit/4a503135487182523a9db559cff23cd42427ca64))
...
* **proxy:** MemoryDecision contract + 3 bypass bugs + drop 500-char query cap ([4e1b218](https://github.com/agaonker/headroom/commit/4e1b21854456431253952ec4d32b8464133cc667))
* **proxy:** MemoryDecision contract + 3 bypass bugs + drop 500-char query cap ([71d5a7b](https://github.com/agaonker/headroom/commit/71d5a7b5455f92bd07c1cfc95909738687672307))
* **proxy:** plumb CompressionPolicy through proxy + dispatchers (F2.1 c2/6) ([948c8f2](https://github.com/agaonker/headroom/commit/948c8f2069c6c88eaba40196f2235cd279e2064f))
* **proxy:** PR-D3 Bedrock observability + auth-mode integration ([90ef662](https://github.com/agaonker/headroom/commit/90ef66213d8566925ce0b021d84fd094fab79340))
* **proxy:** PR-D4 native Vertex publisher path + ADC bearer auth ([c10a219](https://github.com/agaonker/headroom/commit/c10a2195afdf86e0ade17fad53a509de577224d4))
...
* **proxy:** record cache reads/writes on backend-routed streaming ([#327](https://github.com/agaonker/headroom/issues/327)) ([7ddc0ce](https://github.com/agaonker/headroom/commit/7ddc0cef1eb7b58021fcb57f6c2a7f00a6f090c7))
* **proxy:** record cache reads/writes on backend-routed streaming ([#327](https://github.com/agaonker/headroom/issues/327)) ([3e97a0c](https://github.com/agaonker/headroom/commit/3e97a0cb73a5801496dc1ae2dab9e81788d87b2a))
* **proxy:** recover SSE usage from truncated final event ([b166bd3](https://github.com/agaonker/headroom/commit/b166bd3d6a9b50925bd0fee5dedce704666ee35e))
* **proxy:** recover SSE usage from truncated final event ([d91254a](https://github.com/agaonker/headroom/commit/d91254a0f2419dbd77e6b8f3b6718a029b725082))
...
* **proxy:** rustfmt drift in live_zone_anthropic imports (F2.1 c2 followup) ([0546795](https://github.com/agaonker/headroom/commit/05467955479d9578934a956c29581997d12a1b16))
...
* **proxy:** Strands MCP bundle + backend path fixes + Codex fail-closed protection ([20dc1f2](https://github.com/agaonker/headroom/commit/20dc1f28f3ccadbc2d1109d73b5bfe875eb81c47))
* **proxy:** surface CompressionDecision.passthrough_reason in tags ([88983ad](https://github.com/agaonker/headroom/commit/88983ad34efef0556be9baeb1dd57397e4e6d724))
* **proxy:** surface CompressionDecision.passthrough_reason in tags ([e4e28b6](https://github.com/agaonker/headroom/commit/e4e28b65f459df6879b38384842faaeba6357a2a))
* **proxy:** thread tags into 13 outcome sites + synth /v1/models + free-fn _extract_tags ([3ec5492](https://github.com/agaonker/headroom/commit/3ec549288aed46dc46067b6dc55f287a8b19d218))
* **proxy:** thread tags into 13 outcome sites; synthesize /v1/models for ChatGPT auth ([6d62985](https://github.com/agaonker/headroom/commit/6d62985b73b4a9e50d13ee9fc3df4b62bcba1c14))
...
* **proxy:** unblock Codex WS compression — delete inner-pool + global semaphore ([6cf8f7f](https://github.com/agaonker/headroom/commit/6cf8f7f44abf82b5a34572ead0b6ee0bf523a6ce))
* **proxy:** unblock Codex WS compression — delete inner-pool + global semaphore ([a167f5c](https://github.com/agaonker/headroom/commit/a167f5cc299ae78ce94cc6ddc3694af26c5c408b))
* **proxy:** wire CompressionPolicy through handlers + flip default enabled (F2.1 c5/5) ([0fef428](https://github.com/agaonker/headroom/commit/0fef428f1fecff6a72a355098457bacc6465ef5f))
* **proxy:** wire PyO3 compression into /v1/responses handler (hot-fix c2/2) ([c0baaf0](https://github.com/agaonker/headroom/commit/c0baaf052f18b2561226d20de6b182bb14300416))
* re-enable Codex /v1/responses compression + fix prose-format over-freeze ([7aaa4ac](https://github.com/agaonker/headroom/commit/7aaa4ac48fcada1dc8e44477dc8256153d75093b))
* register serena mcp during wrap ([44231f6](https://github.com/agaonker/headroom/commit/44231f68cd8bbbd010defdba2fb919bf49bafc89))
* register serena mcp during wrap ([a7160f7](https://github.com/agaonker/headroom/commit/a7160f7eab87813f065ab398692231398c221b87))
...
* remove env_key from injected Codex provider — fixes [#393](https://github.com/agaonker/headroom/issues/393) ([7fb6d7f](https://github.com/agaonker/headroom/commit/7fb6d7fefdce6145a39485b0c7d3227bdd573530))
...
* ship glibc 2.38 compat shim + wheel symbol audit (closes [#355](https://github.com/agaonker/headroom/issues/355)) ([6793adb](https://github.com/agaonker/headroom/commit/6793adb003e1efb8ba6a6446a7829de2602a266f))
* ship glibc 2.38 compat shim + wheel symbol audit (closes [#355](https://github.com/agaonker/headroom/issues/355)) ([e214672](https://github.com/agaonker/headroom/commit/e2146724af09801c8f75dcd357d1a61c91d6bbb0))
...
* speed up Kompress inference ([98f73e3](https://github.com/agaonker/headroom/commit/98f73e3502c62dbc2c4119dcc68ef27537cc8f58))
...
* stabilize codex compression, stats, and proxy lifecycle ([eaf5980](https://github.com/agaonker/headroom/commit/eaf5980b4ac48c909a1fa2ef1ace460752ec0918))
* stabilize learn write-failure worker test ([155c069](https://github.com/agaonker/headroom/commit/155c0691767d68f7ec5b47de476f8215946901bf))
...
* **subscription:** address G2 review findings — phantom delta, multi-worker race, silent fallbacks ([f68090c](https://github.com/agaonker/headroom/commit/f68090c5b4bd9670ee7fc9a0c71e57f05072c18c))
* **subscription:** wire tokens_saved_rtk data plane ([c7d1247](https://github.com/agaonker/headroom/commit/c7d1247a2bd06738c3b6c8e73e15902a7e428467))
* **subscription:** wire tokens_saved_rtk from RTK stats endpoint ([44c605f](https://github.com/agaonker/headroom/commit/44c605fbb0e3ae4e7a92d9693d0da8bc21115b81))
...
* sync Codex MCP proxy config during wrap ([ac1d11c](https://github.com/agaonker/headroom/commit/ac1d11c9a2a946ad5362db106cf9094262b7329a))
* **telemetry:** honour HEADROOM_TELEMETRY=off in /v1/telemetry collector ([218821e](https://github.com/agaonker/headroom/commit/218821e4897dfcb78382b95330fc69cd08d9ccc1))
* **telemetry:** honour HEADROOM_TELEMETRY=off in /v1/telemetry collector ([#390](https://github.com/agaonker/headroom/issues/390)) ([9ddbdf2](https://github.com/agaonker/headroom/commit/9ddbdf2313eb4a77ad6cff3a0ae5eb0264cf7c57))
* **tests:** drive RTK subprocess failure with real exec, not monkeypatched run ([9b6d637](https://github.com/agaonker/headroom/commit/9b6d6374f13a88842a1944688005649ad3680acd))
* **tests:** make codex scheduler stress test machine-independent ([f82d61b](https://github.com/agaonker/headroom/commit/f82d61b1636cfa7d75aeca01f32df070cff3318d))
* **tests:** make stress test CI-robust — uniform frame sizes, tighter ratio ([c22342e](https://github.com/agaonker/headroom/commit/c22342e1c7e909b3270d19fbaa5583b91a166952))
* **tests:** mock logger.warning directly instead of relying on caplog ([c38dac3](https://github.com/agaonker/headroom/commit/c38dac301e6bc702979ab11357a9c27a180ae060))
* **tests:** patch headroom.rtk.get_rtk_path, not the helpers alias ([317dffe](https://github.com/agaonker/headroom/commit/317dffe58fb0c6233210bbc9e42ebf16b9288391))
* **tests:** ship scripts/replay_codex_ws_load.py so CI can import it ([e532763](https://github.com/agaonker/headroom/commit/e53276302ef9585be37519b16eb94513242372e7))
...
* **tests:** update CacheAligner detector-only tests for F2.2 5-field CompressionPolicy ([be5d9f7](https://github.com/agaonker/headroom/commit/be5d9f7baaf11d706afecf7c0ca0b9da984f38a2))
* **tests:** widen wrap-e2e openclaw startup timeout from 5s to 30s ([2ae88a6](https://github.com/agaonker/headroom/commit/2ae88a6874b19ec9c4173b5a41e4f09918d2a348))
* **tests:** widen wrap-e2e openclaw startup timeout to 30s ([2febf1b](https://github.com/agaonker/headroom/commit/2febf1bbbfd0e2d7fde438afff93b9e2e9c9d093))
* **transforms:** F2.2 c2/3 — wire toin_read_only gate + extend policy_selected log ([5b38cbf](https://github.com/agaonker/headroom/commit/5b38cbf8a79d146adb6ca2ee25974bc35e271b05))
* **transforms:** Python parity port of CompressionPolicy + cache_aligner gate (F2.1 c4/5) ([de8e245](https://github.com/agaonker/headroom/commit/de8e245990399442145a2aa5a8fe61eb4ddb3a76))
...
* **vertex,bedrock:** remove dead handle_raw_predict, honour X-Forwarded-Proto, cap Bedrock body size ([c6ecdc4](https://github.com/agaonker/headroom/commit/c6ecdc429923872a9821e2e191da4990d41e8ad4))
* **vertex,bedrock:** remove dead handle_raw_predict, honour X-Forwarded-Proto, cap Bedrock body size ([28b2bac](https://github.com/agaonker/headroom/commit/28b2bacdf6ffebb1c2bfa81ea80a3862f8ef0e24))
* Windows ORT builds and Docker signing retries ([5cc3fd4](https://github.com/agaonker/headroom/commit/5cc3fd4852337b64e635b33d9a490e0931e46cef))
...
* **proxy:** collapse 3 stream finalizers onto RequestOutcome.from_stream ([af50390](https://github.com/agaonker/headroom/commit/af503905b584e61eac37d14e290b3033074ffc24))
* **proxy:** collapse 3 stream finalizers onto RequestOutcome.from_stream ([694589f](https://github.com/agaonker/headroom/commit/694589fec4997ae60118aa3609672a9ed3262a8f))
* **proxy:** CompressionDecision contract + 4 missing-gate bug fixes ([1699435](https://github.com/agaonker/headroom/commit/1699435ddfd10f3918fcd18e1fdcfc6b232ebdad))
* **proxy:** introduce RequestOutcome funnel; collapse 3 streaming finalizers ([3762f63](https://github.com/agaonker/headroom/commit/3762f6375ca7a93301f6c3b946f6b1cefb9ca87d))
* **proxy:** introduce RequestOutcome funnel; collapse 3 streaming finalizers ([e898f68](https://github.com/agaonker/headroom/commit/e898f68b89fcf3dd6cd5d7ee199e9f032d4fb20a))
* **proxy:** MemoryRanker + ImageCompressionDecision + branch-aware version-sync ([c79aa22](https://github.com/agaonker/headroom/commit/c79aa22be798a40e19c24cfc3e33427cdd84dc29))
* **proxy:** MemoryRanker + ImageCompressionDecision + branch-aware version-sync ([a7b197c](https://github.com/agaonker/headroom/commit/a7b197c6eca08e0080cb04bc19859026233c5603))
* **proxy:** migrate Codex WS + OpenAI HTTP + batch handlers; delete Databricks ([993c907](https://github.com/agaonker/headroom/commit/993c9076f92558402c5f925a685fde4001f96daf))
* **proxy:** migrate Gemini + Anthropic non-streaming onto outcome funnel ([7aca004](https://github.com/agaonker/headroom/commit/7aca00445e23f421d1c8c278bf720cab046da20f))
